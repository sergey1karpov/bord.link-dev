        ...
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <form action="{{route('generateShortLink')}}" method="POST" id="generateShortLinkForm">
                    @csrf
                    <input type="hidden" name="old_link" value="{{route('events', ['id' => $user->id])}}">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header text-center">
                                        <h4 class="text-center">Добавить мероприятие</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <h6 class=" mt-4 ml-3 mr-3" style="font-size: 0.8rem">Поля формы, которые огуречного цвета - обязательны к заполнению!</h6>
                                    <h6 class=" ml-3 mr-3" style="font-size: 0.8rem">Для корректного и красивого(по нашему мнению) отображения информации, заполняйте поля по их прямому назначению</h6>
                                        ...
                                        <div class=" text-left">
                                            <form action="{{route('addEvent', ['id' => Auth::user()->id])}}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <small id="emailHelp">Добавить афишу мероприятия, если она у вас есть конечно.</small>
                                                </div>
                                                <div class="form-group">
                                                    <input style="background-color: #CEF6CE" type="text" name="title" id="title" placeholder="Алла пугачева" class="form-control" maxlength="30">
                                                    <small>Заголовок вашей афиши. Здесь нужно указать группу, исполнителя. Все символы автоматически переведуться в верхний регистр. Максимальное кол-во символов 30</small>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <small>Выберите дату проведения вашего мероприятия</small>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="time" id="time" placeholder="21:00" class="form-control" maxlength="5">
                                                    <small>Время начала мероприятия</small>
                                                </div>
                                                <div class="form-group">
                                                    <input style="background-color: #CEF6CE" type="text" name="city" id="city" placeholder="Москва, Россия" class="form-control" maxlength="50">
                                                    <small>Место, где пройдем ваше мероприятие</small>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="address" id="address" placeholder="Star club" class="form-control" maxlength="50">
                                                    <small>Место проведения мероприятия. Название какого нибудь клуба, концертной площадки. Максимальное кол-во символов 50</small>
                                                </div>
                                                <div class="form-group">
                                                    <textarea style="background-color: #CEF6CE" name="info" id="info" class="form-control" rows="2" maxlength="1000"></textarea>
                                                    <small>В этом поле можете написасть любую информацию касающуюся вашего мероприятия. Можете разбежаться на 1000 символов</small>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="vk" id="vk" placeholder="Link to the meeting VKontakte" class="form-control" maxlength="100">
                                                    <small>Если у вашего мероприятия есть встреча в ВК, ссылку можете вставить в это поле</small>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="fb" id="fb" placeholder="Facebook meeting link" class="form-control" maxlength="100">
                                                    <small>Место для встречи на Фейсбуке</small>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="concert" id="concert" placeholder="Concert.ru" class="form-control" maxlength="100">
                                                    <small>Если вы распространяете билеты на ваше мероприятие через сервис Concert.ru, в это поле вставьте сылку на покупку билетов</small>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="yandex" id="yandex" placeholder="Yandex Afisha" class="form-control" maxlength="100">
                                                    <small>Если вы распространяете билеты на ваше мероприятие через сервис Яндекс Афиша, в это поле вставьте сылку на покупку билетов</small>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="kassir" id="kassir" placeholder="Kassir.ru" class="form-control" maxlength="100">
                                                    <small>Если вы распространяете билеты на ваше мероприятие через сервис Kassir.ru, в это поле вставьте сылку на покупку билетов</small>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="ponominalu" id="ponominalu" placeholder="Ponominalu.ru" class="form-control" maxlength="100">
                                                    <small>Если вы распространяете билеты на ваше мероприятие через сервис Ponominalu.ru, в это поле вставьте сылку на покупку билетов</small>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="ticketland" id="ticketland" placeholder="Ticketland.ru" class="form-control" maxlength="100">
                                                    <small>Если вы распространяете билеты на ваше мероприятие через сервис Ticketland.ru, в это поле вставьте сылку на покупку билетов</small>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="radario" id="radario" placeholder="Radario.ru" class="form-control" maxlength="100">
                                                    <small>Если вы распространяете билеты на ваше мероприятие через сервис Radario.ru, в это поле вставьте сылку на покупку билетов</small>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="tickets" id="tickets" placeholder="Ссылка на покупку билетов" class="form-control" maxlength="100">
                                                    <input type="text" name="youbrand" id="youbrand" placeholder="Название сервиса" class="form-control" maxlength="100">
                                                    <small>В верхнее поле вставляете ссылку на покупку билетов, а в нижнее, название сервиса, через который распространяете свои билеты </small>
                                                </div>
                                                <button type="submit" class="btn btn-dark btn-sm ml-2 mb-2">Добавить</button>
                                            </form>
                                        </div>
                                    </div>
                    ...
                    @foreach($events as $event)
                        <li class="list-group-item list-group-item-action text-center">
                            <div class="row text-center">
                                <div class="col-12 col-sm-10 col-md-10 col-lg-6 col-xl-6 text-center" style="padding: 0">
                                    <a href="{{route('event', ['id'=>$user->id, 'event'=>$event->id])}}" style="color: black; text-decoration: none">
                                        <p style="font-family: 'Jost', sans-serif; text-transform: uppercase; font-size: 1em; padding: 0; margin: 0"><b>{{$event->city}}</b></p>
                                        <p style="font-family: 'Roboto', sans-serif; font-size: 0.9rem; margin-bottom: 0">{{\Carbon\Carbon::parse($event->eventdata)->format('d.m.Y')}}</p>
                                    </a>
                                </div>
                        ...
                        <div class="col-12 ">
                            @if($user->id == Auth::user()->id)
                                <div class="row text-center">
                                    ...
                                    <div class="col-6">
                                        <h6 style="margin-top:2px; font-family: 'Jost', sans-serif; font-size: 1em; margin-bottom: 0; color: #f4f4f2; text-transform: uppercase; " data-toggle="modal" data-target="#exampleModalCenter">добавить</h6>
                                    </div>
                                </div>
                            @endif
                            @if($user->id != Auth::user()->id)
...
{{--                                @if(Auth::check())--}}
{{--                                    @if(Auth::user()->id != $user->id)--}}
{{--                                        <a href="{{route('profile', ['id' => Auth::user()->nackname])}}"><img class="img-footer " style="background-image: url({{Auth::user()->avatar}});"></a>--}}
{{--                                    @endif--}}
{{--                                @endif--}}
{{--                                @if(Auth::guest())--}}
