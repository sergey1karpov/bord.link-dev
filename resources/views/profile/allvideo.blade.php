                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Добавить видео</h5>
                                ...
                                <form action="{{route('addProfileVideo', ['id' => Auth::user()->id])}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small>Группа\Исполнитель - название хита</small>
                                    </div>
                                    <div class="form-group">
                                        <textarea maxlength="1000" name="info" id="videoProfile" class="form-control" rows="2"></textarea>
                                        <small>Любая дополнительная информация в 1000 символов</small>
                                    </div>
                                    <div class="form-group">
                                        <textarea maxlength="1000" name="audio" id="videoProfile" class="form-control" rows="2"></textarea>
                                        <small>Если вы хотите к видео посту, прикрепить аудио дорожку, в это окно вставьте код плеера с треком</small>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <small id="emailHelp" class="form-text text-muted ml-2 mt-2">Вставка видео с YouTube в формате https://www.youtube.com/watch?v=RYnFIRc0k6E</small>
                                    </div>
                                    <h6>Ссылки на сервисы прослушивания\продажи вашего шлягера</h6>
                                    <div class="form-group">
